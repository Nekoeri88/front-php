...
return [
    ...
    'whatIsNanJDescription2' =>
        'NANJCOINはERC223規格に準拠した日本初のEthereumトークンです。<br>スポーツをもっと楽しむというテーマのもと、スポーツに関連する決済手段として提携先を拡大していきます。普通に買い物をするよりもお得になったり、特典があったりといった状況を実現します。また、資金繰りに困るスポーツ選手や団体、例えば国内で支持層の少ないスポーツや地域のスポーツクラブなどへの寄付が手軽にできるようなシステムを構築します。（Stage3以降）また、コミュニティ内でのvote機能の投票権利としても活用される予定です。将来的にはこのvote機能を使って実際のスポーツチームの運営等も行える世界を目指します。',
    'tokenDetail' => 'トークンの詳細',
    'tokenAssign' => 'トークンの割当',
    ...
    'assignDescription' =>
        '今までの仮想通貨は「運営チーム」の所持割合が不透明なものが多く、過半数を所持しているようなものが大半でした。そこでNANJCOINは運営チームの所持割合を明確にし、<strong>全体の1割としました。</strong>これによるメリットは透明性の確保、そして仮に運営チームが売り抜けたとしても過半数を超えていないため相場が崩壊しません。もちろん一気に売り抜けて相場を乱すような行為はしないと明言した上で、二重の対策となります。',
    'roadMapDescription' =>
