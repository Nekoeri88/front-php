<?php
    ...
    return [
        ...
        'assignDescription' =>
            'Until now, the management teams behind many cryptocurrencies have been unclear about the percentage of tokens that they held. Many of them holding a majority of the available supply. Accordingly, the NANJCOIN management team possesses <strong class="strong01">10% of the total supply. </strong>The benefits to this being transparency, as well as protection from a market collapse in the event of the managers selling off their tokens. 60% of the supply was released into the market when NANJCOIN was first listed in March 2018. Furthermore, <strong class="strong02">15% of the supply will be locked up for one year starting on May 1, 2018. </strong>From here on, we plan to continue announcing any lock ups, burns, selling off of tokens on the market, or anything that may affect the value of NANJCOIN approximately one month in advance of the event.',
        'roadMapDescription' =>
