...
<head>
    ...
    <!-- Custom CSS -->
    {!! Html::style('assets/css/lib/calendar2/semantic.ui.min.css') !!}
    {!! Html::style('assets/css/lib/calendar2/pignose.calendar.min.css') !!}
    {!! Html::style('assets/css/lib/owl.carousel.min.css') !!}
    {!! Html::style('assets/css/lib/owl.theme.default.min.css') !!}
...
<body class="fix-header fix-sidebar">
    ...
    <!-- Amchart -->
    {{ HTML::script('assets/js/lib/morris-chart/raphael-min.js') }}
    {{ HTML::script('assets/js/lib/morris-chart/morris.js') }}
    {{ HTML::script('assets/js/lib/morris-chart/dashboard1-init.js') }}

    {{ HTML::script('assets/js/lib/calendar-2/moment.latest.min.js') }}
    <!-- scripit init-->
    {{ HTML::script('assets/js/lib/calendar-2/semantic.ui.min.js') }}
    <!-- scripit init-->
    {{ HTML::script('assets/js/lib/calendar-2/prism.min.js') }}
    <!-- scripit init-->
    {{ HTML::script('assets/js/lib/calendar-2/pignose.calendar.min.js') }}
    <!-- scripit init-->
    {{ HTML::script('assets/js/lib/calendar-2/pignose.init.js') }}

    {{ HTML::script('assets/js/lib/owl-carousel/owl.carousel.min.js') }}
    {{ HTML::script('assets/js/lib/owl-carousel/owl.carousel-init.js') }}
